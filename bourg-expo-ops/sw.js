const CACHE='cp-bourg-expo-ops-v17';
const ASSETS=['./','index.html','sync.js?v=6','chat.js?v=6','push.js?v=1','manifest.webmanifest','icon.svg','las-vegas-sign-transparent.png'];
